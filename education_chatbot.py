...
index = pc.Index('cloud-geo-documents')
...
### =================================Call function=======================================###
# print(Education_ChatBot("What is Cairo"))
...
def Education_ChatBot(query):
    ...
    If asked who is Elon Musk, respond with:
    'I'm sorry, I do not know who Elon Musk is. Do you need any other help?'
